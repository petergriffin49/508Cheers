            ...
            <div className="row justify-content-center text-start">
              <div className="col-12 col-md-10 col-lg-8">
                ...
                <div className="mb-4">
                  ...
                  <p className="mb-0">
                    Encouraging youth to harness the power of their stories and lived experiences to advocate for
                    change at City Hall, School Committee meetings, and the State House.
                  </p>
                </div>
                <div className="mb-4">
